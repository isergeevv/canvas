...
exports.ELEMENT_EVENT_TYPES = void 0;
...
})(exports.ELEMENT_EVENT_TYPES || (exports.ELEMENT_EVENT_TYPES = {}));
...
class CanvasElementEventsController {
    ...
    attachEvents = (app) => {
        for (const event of this._eventCallbacks.eventNames()) {
            if (!Object.values(exports.ELEMENT_EVENT_TYPES).includes(event))
                continue;
            const cb = (e) => {
...
class CanvasApp {
    ...
    init = (startScene) => {
        ...
        this._elementEventsController.on(exports.ELEMENT_EVENT_TYPES.POINTER_MOVE, this.onPointerMove);

...
var Canvas = ({ fill, scenes, ...props }) => {
    const [ctx, setCtx] = require$$0.useState();
    const canvasRef = require$$0.useRef();
    const eventListeners = require$$0.useRef({});
    const sceneNameRef = require$$0.useRef(Object.keys(scenes)[0]);
